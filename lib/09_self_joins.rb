...
select craigRoutes.num, craigRoutes.company, craigRoutes.name, sightRoutes.num, sightRoutes.company
from craigRoutes
inner join sightRoutes
on craigRoutes.name = sightRoutes.name
  SQL
end
